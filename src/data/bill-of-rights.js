export const billOfRights = {
  ...
  summary: "The first 10 amendments. These are your core personal rights -- the things the government is specifically forbidden from doing to you.",
  amendments: [
    {
      number: 1,
    ...
    },
    {
      ...
      rights: "Individual citizens have the right to own firearms. This exists so the people always retain the physical ability to defend themselves -- against criminals, invaders, or a tyrannical government.",
      examples: [
        "Red flag laws allow courts to temporarily seize firearms without a criminal conviction, raising due process concerns.",
        "May-issue permit systems where officials have discretion to deny carry permits can result in unequal application -- connected people get permits, regular citizens don't.",
        "The Hughes Amendment (1986) banned civilian ownership of new machine guns, effectively making existing ones cost tens of thousands of dollars -- pricing out regular citizens from a class of arms.",
    ...
    },
    {
      ...
      rights: "This means: police need a warrant (with rare exceptions). That warrant must be specific -- no fishing expeditions. And the standard is probable cause, meaning actual evidence suggesting a crime, not just a hunch.",
      examples: [
        "Mass surveillance programs that collect everyone's phone records, emails, and internet activity without individual warrants violate the spirit of this amendment -- they're the definition of a general search.",
    ...
    },
    {
      ...
      examples: [
        ...
        "Civil asset forfeiture bypasses due process -- your property is 'charged' (not you), so criminal protections don't apply. The case is literally 'United States v. $35,000 in Currency.'",
        "Plea bargaining pressures innocent people to plead guilty. When facing decades in prison at trial vs. months with a plea, even innocent people take the deal -- undermining the grand jury protection.",
    ...
    },
    {
      ...
      examples: [
        ...
        "Class action waivers combined with arbitration clauses can make it economically impossible to pursue valid claims -- you can't join together, and individual arbitration costs more than the claim is worth."
      ],
      references: [
    ...
    },
    {
      ...
      examples: [
        ...
        "Municipalities that fund their budgets through aggressive fines and fees on residents (traffic tickets, court costs, late fees on fines) -- using the justice system as a revenue source.",
    ...
    },
    {
      ...
      translation: "Just because a right isn't specifically listed here doesn't mean you don't have it. This list isn't complete -- you have more rights than what's written down.",
      ...
      examples: [
        ...
        "The right to travel between states, the right to vote (originally), the right to raise your children as you see fit -- none explicitly listed, all protected.",
    ...
    },
    {
      ...
      translation: "If the Constitution doesn't specifically give a power to the federal government, that power belongs to the states or to the people. The federal government only has the powers listed here -- nothing more.",
      ...
      examples: [
        ...
        "Federal funding conditions -- 'do what we say or lose highway money' -- pressure states into compliance with federal wishes on matters reserved to the states.",
